...
if (mySerial.available()>0) 
  ...
  String sensor3distance = mySerial.readStringUntil('3');
  float float_sen3 = sensor3distance.toFloat();
  String sensor4distance = mySerial.readStringUntil('4');
  ...
  if (float_sen1 < 150 && float_sen2 < 200 && float_sen3 < 200 && float_sen4 < 150) {
    ...
    lcd.print("cm");  //Print your units.
    lcd.setCursor(0,4);  //Set LCD cursor to upper left corner, column 0, row 0
    lcd.print("BACK: ");  //Print Message on First Row
    lcd.setCursor(9,4);   //Set Cursor again to first column of second row
...
if (float_sen1 > 150 && float_sen2 > 200 && float_sen3 > 200 && float_sen4 < 150) {
  ...
  if (float_sen1 > 150 && float_sen2 > 200 && float_sen3 < 200 && float_sen4 < 150) {
   ...
   if (float_sen1 > 150 && float_sen2 < 200 && float_sen3 < 200 && float_sen4 < 150) {
    ...
    lcd.setCursor(9,0);   //Set Cursor again to first column of second row
    lcd.print(float_sen1); //Print measured distance
    lcd.print("cm");  //Print your units.r
   }}}
